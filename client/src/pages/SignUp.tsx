 ...
 *
 * No verification code here — email verification happens at **sign-in**, where
 * a code is mailed to the address on the account. Sign-up just creates the
 * account.
 *
 * No company name or code is asked for either: there is only one company and
 * its details are fixed server-side. The caller picks their own role, and the
